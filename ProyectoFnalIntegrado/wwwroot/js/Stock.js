...
function loadSuppliers() {
    $.ajax({
        url: '/Supplier/GetSuppliersByEstablishment',
        type: 'GET',
...
function loadMedicinesBySupplier(supplierId) {
    ...
    $.ajax({
        ...
        success: function (medicines) {
            ...
            console.log("Medicamentos recibidos:", medicines);
    ...
    $.each(medicines, function (index, medicine) {
        medicinesList.append(
            `<tr>
                ...
                <td>
                    <button class="btn btn-success" onclick="assignMedicine(${medicine.id}, '${medicine.name}', ${medicine.quantity})">Asignar</button>
                </td>
            </tr>`
        );
    });
...
//function loadNurseReport() {
//    $.ajax({
//        url: `/Supplier/NurseReport`, // URL sin parámetros adicionales
//        type: 'GET',
